...
% Also use only TW samples
tongueMaskTW = sampleInfo(:,7) == "TW";
df = df(tongueMaskTW,:);
sampleInfo = sampleInfo(tongueMaskTW,:);
...
path = "./20241212_Tongue_UNOISE_TW_3comp/";
