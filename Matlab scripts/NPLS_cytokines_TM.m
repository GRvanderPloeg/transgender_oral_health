...
cytokineMaskTM = sampleInfo(:,2) == "TM";
df = df(cytokineMaskTM,:);
sampleInfo = sampleInfo(cytokineMaskTM,:);
...
path = "./20241212_Cytokines_TM_3comp/";
...
T = str2double(cytokineAnnotatedModel{1}(:,1:numComponents_cytokines));
b = inv(T'*T) * T' * testosterone;
ypred_cytokine_combined = T * b;
y_cytokine = [ypred_cytokine_combined cytokine_subjectMeta_filtered testosterone];
