...
path = "./20240506_NPLS_rerun/Tongue_original/";
...
[tongue_cube, tongueSubjectMeta, tongueConditionMeta] = rawDataToCube(tongue_filtered, sampleInfo(:,12), str2double(sampleInfo(:,13)), keepIndividuals);
...
tongue_subjectMeta_filtered = sortrows(unique(sampleInfo(:,[12 7]), "rows"), 1);
