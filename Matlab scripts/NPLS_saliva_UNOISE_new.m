...
path = "./20241212_Saliva_UNOISE_combined_binary/";
...
maxComponents = 10;
[XValResult_saliva,~] = ncrossreg(saliva_cnt_scl_filtered, Y, maxComponents, 0);
...
%%
% Run NPLS
[Xfactors_saliva,Yfactors_saliva,Core_saliva,B_saliva,ypred_saliva,ssx_saliva,ssy_saliva,reg_saliva] = npls(saliva_cnt_scl_filtered, Y, numComponents_saliva);
...
y_saliva = [ypred_saliva(:,:,1) saliva_subjectMeta_filtered Y];
...
[coeff_mean_saliva, coeff_std_saliva] = CV_coeff_NPLS(saliva_cnt_scl_filtered, Y, numComponents_saliva, 1);
