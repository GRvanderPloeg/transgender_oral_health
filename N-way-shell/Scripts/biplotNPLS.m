function biplotNPLS(X, model, individual_mode_metadata, feature_mode_metadata, colorbarLabel, featureOffset, plot_title, path)
...
if numFactors==2
    ...
    scatter(individual_mode(:,1), individual_mode(:,2), 20, individual_mode_metadata, "filled"); cbar; colormap jet;
