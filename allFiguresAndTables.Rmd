...
temp=as.numeric(as.factor(tongue_full$dataset$mode1[,2]))
roc(temp, ypred_tongue$V1)
...
temp=as.numeric(as.factor(saliva_full$dataset$mode1[,2]))
roc(temp, ypred_saliva$V1)

## Cytokine full
ypred_cytokines = read.csv("./20241212_Cytokines_combined_binary/Cytokine_1_ypred.csv", header=FALSE) %>% as_tibble()
temp=as.numeric(as.factor(cytokines_full$dataset$mode1[,2]))
roc(temp, ypred_cytokines$V1)
